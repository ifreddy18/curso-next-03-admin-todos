		...
		<div className="sticky top-0 z-10 h-16 border-b bg-white lg:py-2.5">
			<div className="flex items-center justify-between space-x-4 px-6">
				...
				<div className="flex space-x-2">
					...
					<Link href="/dashboard/cart" className="flex h-10 items-center justify-center rounded-xl border bg-gray-100 p-2 focus:bg-gray-100 active:bg-gray-200">
						{totalItems > 0 && (
							<span className="mr-1 text-sm font-bold text-blue-800">
								{totalItems}
							</span>
						)}
